      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 space-y-8 text-slate-700">
          ...
          <section>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6">
              <li><strong>Manual invoices — 1%</strong> (minimum ₦50), <strong>capped at ₦100 for invoices up to ₦100,000</strong>, then +₦100 for every additional ₦100,000. This fee is charged from your prepaid wallet when the invoice is created.</li>
