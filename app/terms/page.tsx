        ...
        <div className="mt-12 space-y-8 text-slate-700">
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              commission per invoice, with fees as low as 0.5%:
            </p>
            <ul className="mt-4 list-disc space-y-2 pl-6">
              <li><strong>Manual invoices — 0.5%</strong> (minimum ₦100), capped at ₦400 for invoices under ₦500,000; from ₦500,000 up it is an uncapped 0.5%. This fee is charged from your prepaid wallet when the invoice is created.</li>
