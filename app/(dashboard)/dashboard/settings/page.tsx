...
import { AlertTriangle, Mail, MessageCircle, User, Image, Building2, CreditCard, Users, Shield } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-6 sm:py-10 text-brand-text">
        ...
        {/* ─── WhatsApp Connection ─── */}
        <Card className={`mb-6 sm:mb-8 ${!phoneVerified ? "ring-2 ring-emerald-400 ring-offset-2" : ""}`}>
          ...
          <CardContent className="pt-4 sm:pt-6 px-4 sm:px-6">
            <PhoneNumberSection
              currentPhone={
                phoneVerified && user?.phone ? user.phone : null
              }
