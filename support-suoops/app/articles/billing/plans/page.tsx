      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-3 text-lg text-slate-600">
            Every feature is <strong>free</strong>. Fees as low as <strong>0.2% per invoice</strong> —
        ...
        <div className="mb-10 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl border-2 border-emerald-500 p-6">
            ...
            <div className="mb-4">
              <span className="text-3xl font-bold text-slate-900">0.2%</span>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-emerald-500" />
                <span>Minimum ₦50 (about ₦200 per ₦100,000)</span>
              </li>
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-emerald-500" />
        ...
        <article className="prose prose-slate prose-emerald max-w-none">
          ...
          <p>
            Manual invoices are funded by a prepaid wallet. Each manual invoice costs just 0.2%
            (minimum ₦50 — about ₦200 per ₦100,000), deducted when you create the invoice. New
          ...
          <p>
            For manual invoices, the 0.2% fee is taken from your wallet the moment you create the
          ...
          <p>
            ...
            everyone; you only pay 0.2% when you invoice (3% on storefront orders paid online).
          </p>
          ...
          <p>
            Just 0.2% per manual invoice (3% on storefront orders). For storefront/online card and
        ...
        <div className="mt-12 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 p-8 text-center">
          ...
          <p className="text-slate-600 mb-4">
            Every feature is free — you only pay 0.2% when you invoice.
          </p>
          <a
