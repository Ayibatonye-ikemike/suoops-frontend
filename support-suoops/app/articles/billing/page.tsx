...
const articles = [
  { 
    ...
    description: "How the 0.5% invoice fee works, funding your prepaid wallet, and online payments — no plans or monthly fees."
  },
];
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600">Fees as low as 0.5%, your wallet, and online payments</p>
            </div>
          </div>
        </div>
