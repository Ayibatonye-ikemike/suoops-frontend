 ...
 * - Fees as low as 0.1%:
 *   • Manual invoices: max(0.1% of amount, ₦50) from a prepaid wallet at
 *     creation (≡ ₦100 per ₦100,000 of transaction value).
...
export const MANUAL_FEE_PERCENT = 0.1;
...
/** Safety fee ceiling (₦) per ₦100,000 band for a manual invoice (≡ 0.1%). */
...
/** Roughly how much invoicing a top-up covers, at the 0.1% manual rate. */
...
/** The single free tier. All features are included; you only pay 0.1% per invoice. */
export const FREE_PLAN: Plan = {
  ...
  price: 0,
  priceDisplay: "₦0",
  invoicesDisplay: "All features free · 0.1% per invoice",
  icon: "🚀",
  description: "Everything included. We just take 0.1% when you invoice.",
  features: [
    "All features included — no plans",
    "0.1% per invoice (min ₦50), from your wallet",
