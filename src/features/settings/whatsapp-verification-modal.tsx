/**
 * WhatsApp Phone Linking Modal
 *
 * Simple modal to add a WhatsApp phone number.
          ...
          <div className="space-y-4">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Enter your WhatsApp number to start creating invoices via chat.
              </p>
            </div>
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    let message = "Failed to save phone number. Try again.";
