          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-brand-textMuted text-brand-charcoal/60 transition-colors hover:bg-brand-evergreen hover:text-white"
