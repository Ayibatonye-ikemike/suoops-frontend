    ...
    <section className="bg-brand-evergreen px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-brand-jade/15 px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-brand-jade">
            🛡 Buyer &amp; Seller Protection
          </span>
          <h2 className="mt-4 font-heading text-3xl font-bold text-white sm:text-4xl">
            Every order is protected — for both sides
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-brand-textMuted/90">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-3xl bg-white/5 p-8 ring-1 ring-white/10">
            <div className="flex items-center gap-3">
              <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-jade/20 text-2xl">
                🛒
              </span>
            ...
            <ul className="mt-6 space-y-4">
              {[
                ...
                <li key={t} className="flex gap-3 text-brand-textMuted/90">
                  <Check />
                  <span>{t}</span>
                </li>
              ))}
